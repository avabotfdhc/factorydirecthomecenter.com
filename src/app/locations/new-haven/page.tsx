...
const data: CityLocationData = {
  ...
  lng: -85.0147,
  tagline:
    "Champion manufactured & modular homes delivered to New Haven and eastern Allen County — factory-direct from our Auburn showroom with local delivery and setup.",
  intro: [
  ...
  faqs: [
    {
      ...
      answer:
        "Yes. New Haven and eastern Allen County are within easy reach of our Auburn showroom. We provide delivery, setup, and installation for homes going on private land or approved lots throughout the area.",
    },
    {
      question: "Can I put a manufactured home on land near New Haven?",
      answer:
        "In many parts of Allen County, yes — though placement rules near Fort Wayne and New Haven vary by zoning district. We verify the requirements for your specific parcel and handle permitting so your home is installed to code.",
    },
    {
      question: "How is buying factory-direct different near Fort Wayne?",
      answer:
        "Instead of paying a traditional dealer markup, you buy directly from the factory through us. That means line-item pricing — you see exactly what you're paying for the home, delivery, and setup — and shorter delivery times because the Champion factory is close by.",
    },
    {
