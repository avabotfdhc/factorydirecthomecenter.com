...
const locations = [
  ...
  },
  {
    ...
    cities: [
      ...
      { name: "Churubusco", distance: "22 miles", slug: "churubusco" },
      { name: "Albion", distance: "25 miles", slug: "albion" },
      { name: "Columbia City", distance: "30 miles", slug: "columbia-city" },
      { name: "Ligonier", distance: "32 miles", slug: "ligonier" },
