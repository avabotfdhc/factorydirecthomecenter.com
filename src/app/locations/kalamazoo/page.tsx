...
const aeoContent = [
  ...
  { question: "What is the cost to deliver a manufactured home to Kalamazoo?", directAnswer: "Delivery to Kalamazoo costs approximately $3,800 for the 95-mile transport from our Auburn showroom.", supportingDetails: ["This includes interstate transportation, placement, and basic setup.", "We regularly deliver to Michigan and handle all cross-border requirements."], wordCount: 44 },
  { question: "Can I buy a manufactured home in Michigan from an Indiana dealer?", directAnswer: "Yes, we regularly deliver to Michigan and handle all interstate logistics and requirements.", supportingDetails: ["Champion homes meet Michigan building codes and standards.", "We coordinate with Michigan authorities for permits and inspections."], wordCount: 45 }
];
...
const locationFAQs = [
  ...
  { question: "Are there extra costs for Michigan delivery?", answer: "Michigan delivery has the same transparent pricing as Indiana. The $3,800 delivery cost to Kalamazoo includes all transportation, permits, and setup. There are no hidden interstate fees. We handle Michigan sales tax and registration requirements." }
];
