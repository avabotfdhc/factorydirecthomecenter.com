...
const locationFAQs = [
  ...
  { question: "What utilities are available in rural Indiana for manufactured homes?", answer: "Rural properties may use well water, septic systems, and propane or electric heating. We help coordinate utility connections including well drilling, septic installation, and electric service. Many rural Indiana properties already have utility access, or we can help you understand the costs of bringing utilities to undeveloped land." },
  { question: "Are there financing options for rural Indiana manufactured home buyers?", answer: "Yes, rural buyers have access to all our financing options. Chattel loans work well for homes on leased or family land. USDA rural development loans may be available for qualified buyers in eligible rural areas. VA loans serve veterans, and we work with local credit unions familiar with rural Indiana lending." },
  { question: "How does Factory Direct serve rural Indiana buyers differently?", answer: "We understand rural needs: longer driveways, well and septic coordination, and flexible site work timing. Our line-item pricing lets you use local rural contractors you trust for site preparation. Being just 20 miles from the factory means lower delivery costs even to remote rural properties. We regularly deliver to farms and rural acreage throughout northeast Indiana." }
];
    ...
    <>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-[var(--color-charcoal)] grain-overlay text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/hero-home.jpg" alt={generateAltText("location", { name: "Manufactured Homes Rural Indiana", location: "Northeast Indiana" })} fill className="object-cover opacity-30" sizes="100vw" priority />
