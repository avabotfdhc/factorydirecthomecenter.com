...
const aeoContent = [
  ...
  { question: "What counties in rural Indiana does Factory Direct serve?", directAnswer: "We serve Noble, DeKalb, Whitley, Steuben, LaGrange, Wells, and Adams counties in rural northeast Indiana.", supportingDetails: ["Our Auburn location is centrally located to serve all these counties efficiently.", "We're just 30 miles from the Champion factory, keeping delivery costs low for rural buyers."], wordCount: 45 },
  { question: "Are there restrictions on manufactured homes in rural Indiana?", directAnswer: "Rural counties typically have fewer restrictions than cities, with agricultural zones welcoming manufactured homes.", supportingDetails: ["Most rural townships require only building permits and setback compliance.", "You or your contractor confirms zoning for the parcel before purchase; we can point you to the right office."], wordCount: 44 },
