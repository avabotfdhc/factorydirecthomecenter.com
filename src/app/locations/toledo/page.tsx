    ...
    <>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 bg-[var(--color-charcoal)] grain-overlay text-white overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/hero-home.jpg" alt={generateAltText("location", { name: "Manufactured Homes Toledo Ohio", location: "Toledo, OH" })} fill className="object-cover opacity-30" sizes="100vw" priority />
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <FadeIn direction="up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+12603081457" onClick={() => trackPhoneClick("toledo_cta")} className="btn-primary inline-flex items-center justify-center bg-[var(--color-teal)] text-white px-8 py-4 text-sm font-bold tracking-widest uppercase hover:bg-[var(--color-teal-dark)] transition-colors duration-300 rounded-lg">Call (260) 308-1457</a>
