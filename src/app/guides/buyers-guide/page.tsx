            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-[var(--color-cream-dark)] p-6 rounded-lg my-6">
                ...
                <ul className="space-y-2">
                  <li className="flex justify-between"><span>Home (single wide)</span><span>$39,900 - $80,000</span></li>
                  <li className="flex justify-between"><span>Home (multi-section)</span><span>$80,000 - $175,000</span></li>
