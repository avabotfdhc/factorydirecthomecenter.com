...
const guideFAQs = [
  ...
  { question: "Can I put a manufactured home on my own land?", answer: "Yes, manufactured homes can be placed on private land in most areas, though zoning restrictions vary. Rural counties typically have fewer restrictions than cities. You'll need to verify zoning compliance, obtain permits, prepare the site (clearing, foundation, utilities), and ensure road access for delivery. Your own licensed contractors handle the site work — ask us for our referral list of licensed and insured contractors — and we can help you check your property's zoning suitability before purchase." },
