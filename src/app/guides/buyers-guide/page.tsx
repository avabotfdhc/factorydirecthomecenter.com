...
const guideFAQs = [
  ...
  { question: "How much does a manufactured home really cost?", answer: "Every home is quoted line-item — the home, each option, and delivery priced separately — so you see exactly what you're paying for; contact us for current pricing on any floor plan. Beyond the home itself, budget for delivery ($2,500-$8,000), setup ($5,000-$15,000), and site work ($5,000-$50,000+). Financing options can make monthly payments comparable to apartment rent." },
  { question: "Can I put a manufactured home on my own land?", answer: "Yes, manufactured homes can be placed on private land in most areas, though zoning restrictions vary. Rural counties typically have fewer restrictions than cities. You'll need to verify zoning compliance, obtain permits, prepare the site (clearing, foundation, utilities), and ensure road access for delivery. Your own licensed contractors handle the site work, the foundation and the setup — ask us for our referral list of licensed and insured contractors — and you or your contractor confirms the parcel's zoning before purchase." },
  { question: "What financing options are available for manufactured homes?", answer: "Several financing options exist: Chattel loans (home-only, no land required), land-home packages (home and land financed together), and conventional mortgages for modular homes on permanent foundations. Credit requirements vary by lender. We are not a lender and do not recommend one — you choose your own, from a list of lenders our customers have used." },
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-[var(--color-cream-dark)] p-6 rounded-lg my-6">
                ...
                <ul className="space-y-2">
                  <li className="flex justify-between"><span>Home (single wide, multi-section, or modular)</span><span>Line-item quote — contact us</span></li>
