...
export const blogPosts: BlogPost[] = [
  ...
  // ===== NEW POSTS (June 2026) =====
  {
    ...
    description: "Interest rates, housing market conditions, and our current factory-direct promotion make this the ideal time to buy. Learn why savvy buyers are acting now.",
    ...
    cta: { text: "Take advantage of our current promotion on select models — see the sale page for the discount running today.", href: "/contact-us", label: "See the current offer" },
    faqs: [
      { question: "Is summer a good time to buy a manufactured home?", answer: "Yes. Summer 2026 offers a unique combination of favorable factors: competitive interest rates stabilizing after recent volatility, a factory-direct promotion running on select models, and faster delivery times due to optimal weather conditions for site preparation and delivery. Factory build times are also typically shorter in summer months." },
      ...
      { question: "Should I buy now or wait for lower prices?", answer: "Waiting for lower prices is risky. Factory material costs continue to rise gradually, and demand for manufactured homes is at a 20-year high. A promotional discount off MSRP represents immediate savings that may not be available later, and current promotions are listed on our sale page. Locking in today's pricing protects you from future increases." },
    ],
    published: true,
  },
  {
    ...
    faqs: [
      ...
      { question: "How much can I save with factory direct pricing?", answer: "Factory direct pricing typically saves buyers 15% to 30% compared to traditional dealer pricing. On a $100,000 manufactured home, that's $15,000 to $30,000 in savings. Our current promotion adds a further discount off MSRP — see the sale page for the offer running today." },
