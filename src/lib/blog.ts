...
export const blogPosts: BlogPost[] = [
  ...
  // ===== NEW POSTS (June 2026) =====
  {
    ...
    faqs: [
      ...
      { question: "What is the promotion?", answer: "Factory Direct Homes Center is offering up to 25% off Manufacturer's Suggested Retail Price on select new Champion floor plans through July 31, 2026. This is a factory-direct savings — no middleman markup means you pay significantly less than retail pricing. Contact us for eligible models and availability." },
