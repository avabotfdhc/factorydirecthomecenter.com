...
- Financing: we are NOT a lender, we do not arrange or broker financing, and we do not pull credit. The buyer chooses their own lender; we hand over a list of lenders our customers have used. Lenders on that list include 21st Mortgage, Triad Financial Services, Credit Human and Lake Michigan Credit Union. Chattel (home-only) loans, land-home packages and conventional mortgages (modular). Cash and land-equity buyers qualify for Factory Direct preferred cash discounts on select plans.
